...
RUN  pip install --upgrade setuptools && pip install numpy==1.13.3 numexpr==2.6.4 requests==2.18.4 pandas==0.20.3 elasticsearch==5.4.0 zdesk boto3 influxdb pyjks
